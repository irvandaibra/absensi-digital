    ...
    <main class="flex-shrink-0">
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-white py-3">
            <div class="container px-5">
                <a class="navbar-brand" href="index.html"><span class="fw-bolder text-primary">Absensi</span></a>
                ...
                <div class="row gx-5 align-items-center">
                    <div class="col-xxl-5">
                        ...
                        <div class="text-center text-xl-start">
                            ...
                            <h5 class="display-5 fw-bolder mb-5"><span class="text-gradient d-inline">Absensi Digital</span></h5>
                            <div class="col-xxl-7">
                ...
                <div class="row gx-5 justify-content-center">
                    <div class="col-xxl-8">
                        <div class="text-center my-5">
                            ...
                            <p class="lead fw-light mb-4">Mengelola Absens Kegiatan</p>
                            <p class="text-muted">Demi kelancaran suatu kegiatan rutin
                                Memudahkan pengurus dalam mengatur Anggota nya
                                Anggota bisa meningkatkan kehadiran nya
